    ...
    if (!modal) {
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <button class="btn-primary" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: #94a3b8; margin-top: 2rem; width: 100%; border-radius: 12px; padding: 1.2rem; min-height: 54px; font-weight: 700;" onclick="closeExportModal()">
                    CANCEL EXPORT
                </button>
            </div>
        `;
...
// Export Logic (Standard CSV/PDF functions)
window.exportCSV = function() {
    ...
    window.currentReportData.forEach(function(row, index) {
